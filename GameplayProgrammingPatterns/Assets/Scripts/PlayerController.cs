...
public class PlayerController : MonoBehaviour {
	...
	public void Move(Vector3 _velocity) { //used to set velocity, recieves input from player
		velocity = _velocity;
	}

	public void LookAt(Vector3 lookPoint){ //turns player to look at mouse position, recieves input from player
